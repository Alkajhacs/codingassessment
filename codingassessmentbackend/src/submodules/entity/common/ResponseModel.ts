...
export class ResponseModel<TDto extends DtoBase> {
  ...
  public SetProblem_Name(RequestId: string): void {
    this.Problem_Name = RequestId;
  }

  public SetProblem(RequestId: string): void {
    this.Problem = RequestId;
  }

  public SetInput(RequestId: string): void {
    this.Input = RequestId;
  }

  public SetOutput(RequestId: string): void {
    this.Output = RequestId;
  }

  public SetConstraints(RequestId: string): void {
    this.Constraints = RequestId;
  }

  public SetExample(RequestId: string): void {
    this.Example = RequestId;
  }
